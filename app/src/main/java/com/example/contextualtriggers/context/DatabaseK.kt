...
class Database private constructor(context: Context) :
    ...
    companion object {
        ...
        private const val GEOFENCE_TABLE_NAME = "Geofences"
        ...
        fun addGeofence(geofence: Geofences) {
        ...
        fun getGeofence(geofenceName: String): Geofences? {
            ...
            if (cursor.moveToNext()) {
                ...
                return Geofences(name, latitude, longitude)
            }
            return null
        }
